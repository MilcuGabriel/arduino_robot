echo "# arduino_robot" >> README.md
git init
git add README.md
git commit -m "first commit"
git branch -M main
git remote add origin https://github.com/MilcuGabriel/arduino_robot.git
...
void SetarePiniPWM(){ //D5,D6 -> ENB,ENA
  DDRD|=0x60;  
}

////////////////////////////////////////////////////////////////////////

void SetarePiniMotoare(){ //IN1,IN2,IN3,IN4 -> B1,B2,B3,B4 | ENA,ENB -> D3,D4
  DDRB|=0x1E;
}

////////////////////////////////////////////////////////////////////////

void SetarePiniSenzorLinie(){//A0,A1,A2,A3,A4
  DDRC|=0x1F;
}

////////////////////////////////////////////////////////////////////////

void SetarePiniSonar(){ //D7,B0
  DDRD|=0x80;
  DDRB|=0x01;
}
